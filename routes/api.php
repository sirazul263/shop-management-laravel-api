...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('/{storeId}')->middleware(['checkUserStore'])->group(function () {
        ...
        Route::post('/brands/create', [BrandController::class, 'createBrand'])->name('createBrand');
        ...
        Route::post('/suppliers/create', [SupplierController::class, 'createSupplier'])->name('createSupplier');
        ...
        Route::post('/products/create', [ProductController::class, 'createProduct'])->name('createProduct');
        ...
        Route::post('/due-amount/update', [SellController::class, 'updatePaidAmount'])->name('updatePaidAmount');
        // Activity Logs
